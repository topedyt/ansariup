...
class ChapterListScreen extends ConsumerWidget {
                      ...
                      return Padding(
                        ...
                        child: GestureDetector(
                          onTap: () => _showModeSelectionSheet(
                              context, chapter.id, chapter.title, theme),
                          child: ClayContainer(
  ...
  void _showModeSelectionSheet(
      BuildContext context, int chapterId, String title, dynamic theme) {
        ...
        child: Column(
          ...
          children: [
            ...
            _GamifiedModeCard(
                theme: theme,
                title: "Practice",
                subtitle: "Unlimited time • Explanations",
                icon: Icons.school_rounded,
                color: Colors.blueAccent,
                onTap: () {
                  context.pop();
                  context.push('/quiz/$chapterId?mode=practice');
                }),
            ...
            _GamifiedModeCard(
                ...
                onTap: () {
                  context.pop();
                  _showQuestionCountDialog(context, chapterId, theme);
                }),
            const SizedBox(height: 16),
          ],
        ),
  ...
  void _showQuestionCountDialog(
      BuildContext context, int chapterId, dynamic theme) {
    showDialog(
      context: context,
            ...
            Wrap(
              ...
              children: [10, 20, 30, 50].map((count) {
                return GestureDetector(
                  onTap: () {
                    context.pop();
                    context.push('/quiz/$chapterId?mode=test&count=$count');
                  },
                  child: ClayContainer(
                      height: 50,
                      width: 80,
          ...
          child: Row(
            children: [
              ...
              Icon(Icons.arrow_forward_ios_rounded,
                  color: theme.subTextColor.withOpacity(0.5), size: 16),
            ],
          ),
        ),
      ),
